...
export default function RootLayout({
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        <header
          className={`flex h-16 mb-2 shrink-0 items-center justify-between transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12`}
        >

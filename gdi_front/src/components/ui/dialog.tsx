...
// ✅ OTIMIZAÇÃO 1: Overlay simplificado - remove backdrop-blur pesado
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // Removido: backdrop-blur-sm (muito pesado)
      // Simplificado: apenas fade básico
...
// ✅ OTIMIZAÇÃO 2: Content com animações mais leves
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Removidas animações complexas de slide e zoom
        // Mantido apenas fade básico
